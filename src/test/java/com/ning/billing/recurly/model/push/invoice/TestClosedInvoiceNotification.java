...
public class TestClosedInvoiceNotification extends TestModelBase {

    @Test(groups = "fast")
    public void testDeserialization() throws Exception {
        // See https://docs.recurly.com/api/push-notifications
        final String notificationData = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                ...
                "  </invoice>\n" +
                "</closed_invoice_notification>\n";
        final ClosedInvoiceNotification notification = xmlMapper.readValue(notificationData, ClosedInvoiceNotification.class);
        ...
        assertEquals(notification.getInvoice().getState(), "collected");
