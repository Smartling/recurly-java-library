...
public class TestTransactions extends TestModelBase {
    @Test(groups = "fast")
    public void testDeserialization() throws Exception {
        //See https://docs.recurly.com/api/transactions
        final String transactionsData =  "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" + 
        ...
        final Transactions transactions = xmlMapper.readValue(transactionsData, Transactions.class);
