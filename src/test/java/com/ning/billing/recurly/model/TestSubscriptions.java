...
public class TestSubscriptions extends TestModelBase {
    ...
    public void testDeserialization() throws Exception {
        ...
        Assert.assertNotNull(subscription.getPlan().getPlanCode(), "gold");
        Assert.assertNotNull(subscription.getPlan().getName(), "Gold plan");

        Assert.assertEquals(subscription.getAccount().getHref(), "https://your-subdomain.recurly.com/v2/accounts/1");
